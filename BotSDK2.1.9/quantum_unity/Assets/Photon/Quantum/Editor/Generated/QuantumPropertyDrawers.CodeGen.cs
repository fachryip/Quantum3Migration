...
namespace Quantum.Editor {
  ...
  [CustomPropertyDrawer(typeof(AssetRefAnyCollectibleExist))]
  public class AssetRefAnyCollectibleExistPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(AnyCollectibleExistAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(AssetRefChooseCollectibleAction))]
  public class AssetRefChooseCollectibleActionPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(ChooseCollectibleActionAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(AssetRefDeliverCollectibleAction))]
  public class AssetRefDeliverCollectibleActionPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(DeliverCollectibleActionAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(AssetRefPickupCollectibleAction))]
  public class AssetRefPickupCollectibleActionPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(PickupCollectibleActionAsset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefStopMovingAction))]
  public class AssetRefStopMovingActionPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(StopMovingActionAsset));
    }
  }

  [CustomPropertyDrawer(typeof(AssetRefTargetExistDecision))]
  public class AssetRefTargetExistDecisionPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(TargetExistDecisionAsset));
    }
  }
  ...
  [CustomPropertyDrawer(typeof(AssetRefVerifyLoadedDecision))]
  public class AssetRefVerifyLoadedDecisionPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(VerifyLoadedDecisionAsset));
    }
  }

  [CustomPropertyDrawer(typeof(Quantum.Prototypes.BotType_Prototype))]
