	...
	public static unsafe partial class HFSMManager
	{
		public static unsafe partial class ThreadSafe
		{
				...
				string transitionId, ref AIContext aiContext)
			{
				...
				{
          var rootName = frame.FindAsset<HFSMRoot>(hfsmData->Root.Id).Path;
					BotSDKEditorEvents.HFSM.InvokeStateChanged(entity, rootName, hfsmData->CurrentState.Id.Value, transitionId);
				}
