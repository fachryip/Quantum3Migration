...
namespace Quantum
{
	...
	public class BotSDKDebuggerSystem : SystemMainThread
	{
		...
		public static Action<Frame, EntityRef, string, int, Func<DelegateGetDebugInfo>> SetEntityDebugLabel;
      ...
      where T : IComponent, IBotSDKDebugInfoProvider
    {
      ...
      {
        SetEntityDebugLabel(frame, entity, customLabel, componentIndex, debugInfoGetter);
      }
    }
